...
@Component({
  selector: 'kd-redeploy-button',
  templateUrl: './template.html',
})
export class RedeployButtonComponent implements ActionColumn {
  ...
  onClick(): void {
    this.onClickSubscription_ = this.verber_.onRedeploy.subscribe(this.onSuccess_.bind(this));
    this.verber_.showRedeployDialog(this.typeMeta.kind, this.typeMeta, this.objectMeta);
  }
