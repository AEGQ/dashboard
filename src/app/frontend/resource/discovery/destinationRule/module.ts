...
@NgModule({
  imports: [
    ...
    UIRouterModule.forChild(
        {states: [destinationRuleState, destinationRuleListState, destinationRuleDetailState]}),
  ],
  declarations: [DestinationRuleList, DestinationRuleComponent],
})
export class DestinationRuleModule {
}
