...
import {IstioIngressComponent} from './component';

export const istioIngressDetailState: Ng2StateDeclaration = {
  name: `${stateName}.detail`,
  url: addNamespacedResourceStateParamsToUrl(stateUrl),
  data: {
    kdBreadcrumbs: {
      label: 'resourceName',
      parent: 'istioIngress.list',
    },
  },
  views: {
    '$default': {
      component: IstioIngressComponent,
    },
    'actionbar@chrome': {
